...
<template>
  ...
  <div class="h-screen w-full flex-center flex-col bg-red relative">
    ...
    <h1 class="hero mix-blend-difference m-auto max-lg:pt-[1.5em] relative">{{ $md(data.title) }}</h1>
    <div class="flex-center h-14 lg:h-16 w-full px-main">
      <a href="#more" class="cta z-30 lg:mt-2.5 lg:mb-auto">{{data.more}}</a>
      <a class="cta z-30 ml-auto lg:hidden" href="mailto:info@interspecies.money">{{data.contact}}</a>
    </div>
  </div>
  ...
  <div class="w-full flex-center flex-col relative">
    ...
    <div class="page section max-lg:max-w-[200px] text-center z-10 mt-[140px] lg:mt-[300px]">
      {{ $md(data.section1.pre) }}
    </div>
    <h1 class="page lg:my-[280px] my-[140px] text-center max-w-[14em] max-lg:max-w-[16rem] lg:h-[2.5em] relative"  >
      <span class="z-10 relative mix-blend-difference">{{data.section1.title}}</span><span class="z-10 relative text-[14px] lg:text-[24px] inline-block -translate-y-[0.5em]  mix-blend-difference">↗</span>
      <div class="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-screen">
        <BgImage src="2.png" />
      </div>
    </h1>
    <p class=" page max-w-[672px] z-10 mix-blend-difference ">{{ $md(data.section1.body) }}</p>
  ...
  <div class="w-full flex-center flex-col relative">
    ...
    <div class="section max-lg:max-w-[166px] text-center z-10 mt-[140px] lg:mt-[300px] page">
    ...
    <div class="relative lg:my-[280px] my-[140px] page flex-center">
      ...
      <h1 class="text-center mix-blend-difference max-w-[18em] z-10">{{data.section2.title}}</h1>
    </div>
    <p class="max-w-[672px] z-10 mix-blend-difference max-lg:mt-1 page">{{ $md(data.section2.body) }}</p>
  </div>
  <div class="flex-center flex-col">
    <!--<div class="lg:hidden absolute pt-96 left-0 w-full h-full flex-center pointer-events-none  -translate-y-[470px]">
      <BgImage src="5.png" />
    </div>-->
    <div class="page section z-10 mt-[140px] lg:mt-[300px]">{{ $md(data.section3.pre) }}</div>
  ...
  <div class="w-full page flex-center flex-col relative">
    <div class="relative mt-[116px] lg:mt-[292px] flex-center flex-col">
      ...
      <p class="max-w-[632px] z-10 relative" >{{ $md(data.section5.body) }}</p>
    <a class="cta mt-6 lg:mt-20 z-10 relative" href="mailto:info@interspecies.money">{{ $md(data.contact) }}</a>
    </div>
  </div>
